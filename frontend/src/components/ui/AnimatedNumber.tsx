...
function SingleNumberHolder({
  ...
  useEffect(() => {
    measure();
    // Re-measure once the webfonts (display font for the countdown) land,
    // so the rolling strips never clip the digits.
    if (typeof document !== "undefined" && document.fonts?.ready) {
      document.fonts.ready.then(() => {
        measure();
        // setTimeout so the layout has time to settle after fonts swap
