  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "group z-50 w-fit text-balance rounded-md border border-white/15 bg-void-2 text-ink px-3 py-1.5 text-[11px] font-body font-medium shadow-[0_8px_30px_rgba(0,0,0,0.6)]",
